...
public class UpdateUserStatisticsJob(IAppDBContext context)
{
    ...
    {
        await context
            .UserStatistics.Include(us => us.User)
            ...
            .ExecuteUpdateAsync(setter =>
                setter
                    ...
                    .SetProperty(
                        ...
                        us =>
                            context.Bookings.Count(b =>
                                b.UserId == us.UserId && b.Status == BookingStatusEnum.Rejected
                            )
                    )
                    .SetProperty(
                        us => us.TotalExpired,
                        us =>
                            context.Bookings.Count(b =>
                                b.UserId == us.UserId && b.Status == BookingStatusEnum.Expired
                            )
                    )
                    .SetProperty(
                        ...
                        us =>
                            context.Bookings.Count(b =>
                                b.UserId == us.UserId && b.Status == BookingStatusEnum.Cancelled
                            )
                    )
                    .SetProperty(
                        us => us.TotalEarning,
