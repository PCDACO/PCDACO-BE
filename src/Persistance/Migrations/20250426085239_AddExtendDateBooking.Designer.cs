...
namespace Persistance.Migrations
{
    ...
    [Migration("20250426085239_AddExtendDateBooking")]
    partial class AddExtendDateBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<decimal?>("ExtensionAmount")
                        .HasColumnType("numeric");
                    ...
                    b.Property<bool?>("IsExtensionPaid")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.BookingLockedBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BookingLockedBalances");
                });

            modelBuilder.Entity("Domain.Entities.BookingReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("CompensationPaidAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("CompensationPaidImageUrl")
                        .HasColumnType("text");

                    b.Property<Guid?>("CompensationPaidUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompensationPaidUserId");
            ...
            modelBuilder.Entity("Domain.Entities.CarContract", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("OwnerSignatureDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTimeOffset?>("TechnicianSignatureDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DriverSignatureDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Entities.InspectionPhoto", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("InspectionCertificateExpiryDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Entities.UserStatistic", b =>
                {
                    ...
                    b.Property<int>("TotalApprovedInspectionSchedule")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalCreatedInspectionSchedule")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalRejectedInspectionSchedule")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.BookingLockedBalance", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "Owner")
                        .WithMany("BookingLockedBalances")
            ...
            modelBuilder.Entity("Domain.Entities.BookingReport", b =>
                {
                    b.HasOne("Domain.Entities.Booking", "Booking")
                        .WithMany("BookingReports")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.User", "CompensationPaidUser")
                        .WithMany()
                    ...
                    b.Navigation("CompensationPaidUser");
            ...
            modelBuilder.Entity("Domain.Entities.CarContract", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.GPSDevice", "GPSDevice")
                        .WithOne("Contract")
                        .HasForeignKey("Domain.Entities.CarContract", "GPSDeviceId");

                    b.HasOne("Domain.Entities.User", "Technician")
                        .WithMany("CarContracts")
            ...
            modelBuilder.Entity("Domain.Entities.InspectionPhoto", b =>
                {
                    b.HasOne("Domain.Entities.CarInspection", "Inspection")
                        .WithMany("Photos")
                        .HasForeignKey("InspectionId");

                    b.HasOne("Domain.Entities.InspectionSchedule", "Schedule")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("Domain.Entities.InspectionSchedule", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.BookingReport", "Report")
                        .WithOne("InspectionSchedule")
                        .HasForeignKey("Domain.Entities.InspectionSchedule", "ReportId");
            ...
            modelBuilder.Entity("Domain.Entities.WithdrawalRequest", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "ProcessedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("BookingLockedBalances");

                    b.Navigation("Bookings");

                    b.Navigation("CarContracts");
