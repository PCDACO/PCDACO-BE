        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_EncryptionKeys_EncryptionKeyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedBankAccount = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankAccounts_EncryptionKeys_EncryptionKeyId",
                        column: x => x.EncryptionKeyId,
                        principalTable: "EncryptionKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptionKeyId = table.Column<Guid>(type: "uuid", nullable: false),
                    EncryptedLicensePlate = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    TotalBooking = table.Column<int>(type: "integer", nullable: false),
                    TotalCancel = table.Column<int>(type: "integer", nullable: false),
                    TotalEarning = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualReturnTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    BasePrice = table.Column<decimal>(type: "numeric", nullable: false),
                    PlatformFee = table.Column<decimal>(type: "numeric", nullable: false),
                    ExcessDay = table.Column<decimal>(type: "numeric", nullable: false),
                    ExcessDayFee = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarAmenities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarAmenities_Amenities_AmenityId",
                        column: x => x.AmenityId,
                        principalTable: "Amenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarAmenities_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarId = table.Column<Guid>(type: "uuid", nullable: false),
                    TotalRented = table.Column<int>(type: "integer", nullable: false),
                    TotalCancellation = table.Column<int>(type: "integer", nullable: false),
                    TotalEarning = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalDistance = table.Column<decimal>(type: "numeric", nullable: false),
                    AverageRating = table.Column<decimal>(type: "numeric", nullable: false),
                    LastRented = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "integer", nullable: false),
                    PlatformFee = table.Column<decimal>(type: "numeric", nullable: false),
                    OwnerEarning = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CumulativeDistance = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TripTrackings_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CarReportId = table.Column<Guid>(type: "uuid", nullable: false),
                    Url = table.Column<string>(type: "text", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccounts_EncryptionKeyId",
                table: "BankAccounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarAmenities_AmenityId",
                table: "CarAmenities",
                column: "AmenityId");

            migrationBuilder.CreateIndex(
                name: "IX_CarAmenities_CarId",
                table: "CarAmenities",
                column: "CarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripTrackings_BookingId",
                table: "TripTrackings",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_EncryptionKeyId",
                table: "Users",
                column: "EncryptionKeyId",
                unique: true);
