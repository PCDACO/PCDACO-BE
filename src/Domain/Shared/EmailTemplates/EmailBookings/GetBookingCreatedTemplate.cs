...
public static class GetBookingCreatedTemplate
{
        ...
        return $@"
            ...
            <div style='padding: 20px; border: 1px solid #ddd; border-radius: 0 0 8px 8px;'>
                ...
                <div style='background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;'>
                    <h3 style='color: #2E7D32; margin-top: 0;'>Chi Tiết Đặt Xe:</h3>
                    <table style='width: 100%; border-collapse: collapse;'>
                        ...
                        <tr style='border-top: 2px solid #ddd;'>
                            ...
                            <td style='text-align: right; color: #2E7D32; font-weight: bold;'>{totalAmount:N0} VNĐ</td>
                        </tr>
                    </table>
                </div>
