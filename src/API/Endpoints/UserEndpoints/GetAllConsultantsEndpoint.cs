...
public sealed class GetAllConsultantsEndpoint : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        app.MapGet("/api/users/consultants", Handle)
            .WithSummary("Get all consultants")
            .WithTags("Users")
            ...
            .WithOpenApi(operation =>
                ...
                {
                    Description = """
                    Retrieve a paginated list of all consultants in the system.
                                        ...
                                        ["value"] = new OpenApiObject
                                        {
                                            ["items"] = new OpenApiArray
                                            {
                                                new OpenApiObject
                                                {
                                                    ...
                                                    ["role"] = new OpenApiString("Consultant"),
    ...
    {
        Result<OffsetPaginatedResponse<GetAllConsultants.Response>> result = await sender.Send(
            new GetAllConsultants.Query(
