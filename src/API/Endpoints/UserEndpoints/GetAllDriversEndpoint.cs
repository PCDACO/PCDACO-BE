    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        app.MapGet("/api/users/drivers", Handle)
            ...
            .WithOpenApi(operation =>
                ...
                {
                    Description = """
                    Retrieve a paginated list of all drivers in the system.
                    ...
                    - Additional driver-specific information (license approval status, ban status)
                    ...
                    Responses =
                    {
                        ["200"] = new()
                        {
                            Description = "Success - Returns paginated list of drivers",
                            Content =
                            {
